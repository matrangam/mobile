...
//
// See the github.com/StartisIOT/gomobile/app package for details on the event model.
package size // import "github.com/StartisIOT/gomobile/event/size"

import (
	"image"

	"github.com/StartisIOT/gomobile/geom"
)
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/StartisIOT/gomobile/geom package.
	//
