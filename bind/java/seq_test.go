...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		...
		if out, err := exec.Command(gocmd, "build", "-o", gomobileBin, "github.com/StartisIOT/gomobile/cmd/gomobile").CombinedOutput(); err != nil {
			log.Fatalf("gomobile build failed: %v: %s", err, out)
		}
		if out, err := exec.Command(gocmd, "build", "-o", gobindBin, "github.com/StartisIOT/gomobile/cmd/gobind").CombinedOutput(); err != nil {
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/StartisIOT/gomobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/StartisIOT/gomobile/bind/testdata/benchmark"}, "", "SeqBench")
}
