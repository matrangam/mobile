...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/StartisIOT/gomobile/example/basic"})
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/StartisIOT/gomobile", "github.com/StartisIOT/gomobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/StartisIOT/gomobile", "github.com/StartisIOT/gomobile", 2},
		{"ffffffff t github.com/example/github.com/StartisIOT/gomobile", "", 0},
